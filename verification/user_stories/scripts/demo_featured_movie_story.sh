...
#
# Usage:
#   ./verification/user_stories/scripts/demo_featured_movie_story.sh
#
...
#
# Examples:
#   BASE_URL=http://localhost:8080 ./verification/user_stories/scripts/demo_featured_movie_story.sh
#   FEATURED_INDEX=1 ./verification/user_stories/scripts/demo_featured_movie_story.sh
#   DEMO_EMAIL=demo@example.test DEMO_PASSWORD=DemoPass123! ./verification/user_stories/scripts/demo_featured_movie_story.sh
