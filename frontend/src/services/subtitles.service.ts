...
export function loginOpenSubtitles() {
    return fetchOpenSubtitles<iLoginOpenSubtitles>("login", JSON.stringify({username: process.env.NEXT_PUBLIC_OPENSUBTITLES_USERNAME, password: "$5pOBfO0kv6#KAzs6SHD"}));
}
