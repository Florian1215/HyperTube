...
export function OAuthIcon({oauth, color="white", size=30}: {oauth: tOauthService, color?: string, size?: number}) {
    ...
    if (oauth === "42") {
        ...
        return (<svg width={size} height={size} className="tanuki-logo" viewBox="0 0 50 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path className="tanuki-shape right-cheek" d="m49.014 19-.067-.18a22.88 22.88 0 0 0-9.12 4.103L24.931 34.187l9.485 7.167 10.393-7.779.03-.022a12.595 12.595 0 0 0 4.175-14.554Z" fill="#FC6D26"/>
            <path className="tanuki-shape chin" d="m15.414 41.354 5.12 3.87 3.11 2.351a2.102 2.102 0 0 0 2.535 0l3.11-2.352 5.12-3.869-9.484-7.167-9.51 7.167Z" fill="#FCA326"/>
            <path className="tanuki-shape left-cheek" d="M10.019 22.923a22.86 22.86 0 0 0-9.117-4.1L.832 19A12.595 12.595 0 0 0 5.01 33.556l.026.02.057.044 10.32 7.734 9.491-7.167L10.02 22.923Z" fill="#FC6D26"/>
        </svg>);
    }
...
export function FullScreenIcon({color="white", iFullScreen=false, size=25}) {
    const fullColor = `var(--color-${color})`;

    if (iFullScreen)
        return (<svg width={size} height={size} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M28.792 18.8076C29.3439 18.808 29.7909 19.2557 29.791 19.8076C29.7909 20.3596 29.3439 20.8073 28.792 20.8076H22.2051L33.6973 32.2998C34.0878 32.6903 34.0878 33.3233 33.6973 33.7139C33.3067 34.1043 32.6737 34.1044 32.2832 33.7139L20.791 22.2217V28.8076C20.7909 29.3598 20.3432 29.8076 19.791 29.8076C19.2389 29.8075 18.7911 29.3597 18.791 28.8076V19.8076C18.7911 19.2555 19.2389 18.8078 19.791 18.8076H28.792ZM0.292969 0.292969C0.683493 -0.0975556 1.31651 -0.0975556 1.70703 0.292969L13.1992 11.7852V5.19922C13.1993 4.64711 13.6471 4.19936 14.1992 4.19922C14.7513 4.19934 15.1991 4.6471 15.1992 5.19922V14.1992C15.1991 14.7513 14.7513 15.1991 14.1992 15.1992H5.19922C4.6471 15.1991 4.19934 14.7513 4.19922 14.1992C4.19936 13.6471 4.64711 13.1993 5.19922 13.1992H11.7852L0.292969 1.70703C-0.0975556 1.31651 -0.0975556 0.683493 0.292969 0.292969Z" fill={fullColor} />
        </svg>);
    return (<svg width={size} height={size} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M19.0986 19.0869C19.4892 18.6964 20.1222 18.6964 20.5127 19.0869L32.0059 30.5791V23.9932C32.006 23.4411 32.4529 22.9934 33.0049 22.9932C33.557 22.9933 34.0048 23.441 34.0049 23.9932V32.9932C34.0048 33.5453 33.557 33.993 33.0049 33.9932H24.0049C23.4528 33.993 23.005 33.5453 23.0049 32.9932C23.005 32.4411 23.4528 31.9933 24.0049 31.9932H30.5908L19.0986 20.501C18.7082 20.1105 18.7082 19.4774 19.0986 19.0869ZM10 0C10.5521 0.000104582 10.9999 0.447884 11 1C10.9999 1.55211 10.5521 1.99989 10 2H3.41406L14.9062 13.4922C15.2968 13.8827 15.2968 14.5157 14.9062 14.9062C14.5157 15.2966 13.8827 15.2967 13.4922 14.9062L2 3.41406V10C1.99989 10.5522 1.55222 11 1 11C0.447897 10.9999 0.000104581 10.5521 0 10V1C0.000121629 0.447903 0.447907 0.000137008 1 0H10Z" fill={fullColor} />
    </svg>);
}
